...
class MainMap extends React.Component {
  ...
  renderHelpText () {
    if (this.state.showHelpText){
      return (
        <View style={{position: 'absolute',top: 0, left:0, right:0, bottom:0, marginRight: -3}}>
          <HelpText language={this.props.language}/>
          <Fab testIDObject={{main: 'helpClose'}} style={{position: 'absolute',top: 0, right: 20, backgroundColor:'white'}} underlayColor={'#e69500'} onPress={this.handleDismissHelp}>
    ...
    return (
      <View style={{flex:1}}>
        <View style={[styles.MainMap, {flex: 4}]}>  
          ...
          <Fab testIDObject={{main: 'menu-fab'}} style={{position: 'absolute',top: 0, backgroundColor:'orange', elevation: this.state.showHelpText ? 0 : 10}} underlayColor={'#e69500'} onPress={this.context.openDrawer}>
